...
// //         <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-neutral-900 dark:text-white drop-shadow-lg">Software with <span className="text-blue-700 dark:text-blue-400">soul</span> — and a deep respect for <span className="text-blue-700 dark:text-blue-400">yours</span>.</h1>
// //         <p className="text-xl sm:text-2xl text-neutral-700 dark:text-neutral-300 mb-8">We turn messy processes into measurable outcomes on ERPNext/Frappe and modern stacks. When systems stall, we make them work — and keep them working.</p>
// //         <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
// //           <a href="#" className="bg-blue-700 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:scale-105 hover:bg-blue-800 transition-all duration-200">Start discovery</a>
// //           <a href="#" className="bg-white border border-blue-700 text-blue-700 px-8 py-4 rounded-full font-semibold shadow-lg hover:scale-105 hover:bg-blue-50 transition-all duration-200 dark:bg-neutral-950 dark:border-blue-400 dark:text-blue-300">How we deliver</a>
// //         </div>
// //       </div>
...
// //         {[
// //           {
// //             title: "Good systems change everything",
// //             points: [
...
// //           <div
// //             key={card.title}
// //             className="bg-white/90 dark:bg-neutral-900/90 rounded-2xl shadow-xl p-8 flex flex-col items-center border border-transparent hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-200 group cursor-pointer"
// //           >
// //             <h3 className="font-bold text-xl mb-3 text-blue-700 dark:text-blue-400 group-hover:underline underline-offset-4">{card.title}</h3>
// //             <ul className="text-neutral-700 dark:text-neutral-300 text-base list-disc list-inside space-y-1">
...
// //       {/* Guarantees & SLAs Section */}
// //       <div className="max-w-5xl w-full mb-20">
// //         <h2 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-blue-700 dark:text-blue-400">Guarantees & SLAs</h2>
// //         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
// //           <div className="bg-white/90 dark:bg-neutral-900/90 rounded-xl shadow p-6 border border-transparent hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-200">
// //             <h4 className="font-semibold mb-2 text-blue-700 dark:text-blue-400">Discovery in 10 Days</h4>
// //             <p className="text-neutral-700 dark:text-neutral-300">Workshops, process map, prototype, and an implementation plan in two weeks or less.</p>
// //           </div>
// //           <div className="bg-white/90 dark:bg-neutral-900/90 rounded-xl shadow p-6 border border-transparent hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-200">
// //             <h4 className="font-semibold mb-2 text-blue-700 dark:text-blue-400">&lt; 24h Response</h4>
// //             <p className="text-neutral-700 dark:text-neutral-300">You get a named engineer and a support channel. We acknowledge and triage within one business day.</p>
// //           </div>
// //           <div className="bg-white/90 dark:bg-neutral-900/90 rounded-xl shadow p-6 border border-transparent hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-200">
// //             <h4 className="font-semibold mb-2 text-blue-700 dark:text-blue-400">Go-Live Assurance</h4>
// //             <p className="text-neutral-700 dark:text-neutral-300">UAT checklist, cut-over plan, rollback steps, and on-site/remote hand-holding until systems stabilize.</p>
// //           </div>
// //         </div>
// //       </div>

// //       {/* Call to Action Section */}
// //       <div className="max-w-3xl w-full text-center py-12 rounded-2xl bg-gradient-to-r from-blue-700 via-blue-500 to-blue-400 text-white shadow-xl mb-8">
// //         <h2 className="text-3xl font-bold mb-4">Ready to turn complexity into clarity?</h2>
// //         <p className="text-lg mb-6">Start with a 10-day discovery sprint - plan, prototype, estimate.</p>
// //         <a href="#" className="inline-block bg-white text-blue-700 font-semibold px-8 py-3 rounded-full shadow hover:bg-blue-100 hover:scale-105 transition-all duration-200">Book discovery</a>
// //       </div>
// //     </section>
// //   );
// // }
...
//         <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 leading-tight tracking-tight text-neutral-900 dark:text-white drop-shadow-lg">
//           {homeData?.hero?.title || 'Welcome to Our Platform'}
//         </h1>
//         {homeData?.hero?.subtitle && (
//           <p className="text-2xl sm:text-3xl font-semibold mb-4 text-blue-700 dark:text-blue-400">
//             {homeData.hero.subtitle}
//           </p>
//         )}
//         <p className="text-xl sm:text-2xl text-neutral-700 dark:text-neutral-300 mb-8">
...
//             className="bg-blue-700 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:scale-105 hover:bg-blue-800 transition-all duration-200"
//           >
//             {homeData?.hero?.primaryButton?.text || 'Get Started'}
//           </a>
//           <a 
//             href={homeData?.hero?.secondaryButton?.link || '#'} 
//             className="bg-white border border-blue-700 text-blue-700 px-8 py-4 rounded-full font-semibold shadow-lg hover:scale-105 hover:bg-blue-50 transition-all duration-200 dark:bg-neutral-950 dark:border-blue-400 dark:text-blue-300"
//           >
...
//       {/* Home Card if exists */}
//       {homeCard && (
//         <div className="max-w-6xl w-full mb-16 bg-white/90 dark:bg-neutral-900/90 rounded-2xl shadow-xl p-8 border border-transparent hover:border-blue-400 hover:shadow-2xl transition-all duration-300">
//           <h2 className="text-2xl font-bold mb-4 text-blue-700 dark:text-blue-400">{homeCard.title}</h2>
//           <p className="text-neutral-700 dark:text-neutral-300 mb-6 text-lg">{homeCard.description}</p>
//           {homeCard.features?.length > 0 && (
//             <ul className="space-y-3 mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
...
//               className="inline-block bg-blue-700 text-white font-semibold px-6 py-3 rounded-full shadow hover:bg-blue-800 hover:scale-105 transition-all duration-200"
//             >
//               {homeCard.buttonText}
//             </a>
//           )}
...
//             <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-neutral-900 dark:text-white">
...
//             {homeData.services.allServices.map((service) => (
//               <div
//                 key={service._id}
//                 className="bg-white/90 dark:bg-neutral-900/90 rounded-2xl shadow-xl p-8 flex flex-col items-center border border-transparent hover:border-blue-400 hover:shadow-2xl hover:scale-105 transition-all duration-200 group cursor-pointer"
//               >
//                 {service.icon && (
//                   <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/30 transition-colors">
//                     <span className="text-2xl">{service.icon}</span> {/* Assuming icon is emoji/text; replace with SVG if needed */}
//                   </div>
//                 )}
//                 <h3 className="font-bold text-xl mb-3 text-blue-700 dark:text-blue-400 group-hover:underline underline-offset-4 text-center">
//                   {service.title}
//                 </h3>
//                 <p className="text-neutral-700 dark:text-neutral-300 mb-4 text-center">{service.shortDescription}</p>
//                 {service.features?.length > 0 && (
//                   <ul className="text-neutral-600 dark:text-neutral-400 text-sm space-y-1 mb-4 list-disc list-inside">
//                     {service.features.slice(0, 3).map((feature, idx) => ( // Limit to 3 for brevity
...
//       {/* Stats Section */}
//       {homeData?.stats && (
//         <div className="max-w-6xl w-full mb-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
//           {Object.entries(homeData.stats).map(([key, value]) => (
//             <div key={key} className="bg-white/90 dark:bg-neutral-900/90 rounded-xl shadow p-6 border border-transparent hover:border-blue-400 hover:shadow-2xl transition-all duration-200">
//               <p className="text-3xl font-bold text-blue-700 dark:text-blue-400 mb-2">{value}</p>
...
//             className="inline-block bg-white text-blue-700 font-semibold px-8 py-3 rounded-full shadow hover:bg-blue-100 hover:scale-105 transition-all duration-200"
//           >
